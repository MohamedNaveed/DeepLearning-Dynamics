...
def plot_phase_portrait(X):
    ...
    plt.grid(True)
    fig.savefig('../results/pendulum_exps/'+ exp_name +'/phasePortrait_1M.png', bbox_inches='tight')
    plt.show()
...
if __name__ == '__main__':
    ...
    data = pd.read_csv('../data/pendulum_exps/diffInitialConditions/traindata_1M.csv')
